...
function iheu_ultimate_oxi_shortcode_function($data, $userdata) {
    ...
    wp_enqueue_script('oxilab-animation-js', plugins_url('public/viewportchecker.js', __FILE__));
