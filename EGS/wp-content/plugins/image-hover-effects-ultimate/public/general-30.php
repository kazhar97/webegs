...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                ...
                . 'iheu-background-color |' . sanitize_text_field($_POST['iheu-background-color']) . '|'
                ...
                . 'heading-font-hover-color |' . sanitize_text_field($_POST['heading-font-hover-color']) . '|'
                            ...
                            <div class="ctu-ultimate-style-3-content">
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-6">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="iheu-background-color" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Set Your image hover background Color, Based on Color">Background </label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="text" class="form-control iheu-vendor-color" data-format="rgb" data-opacity="true" id="iheu-background-color" name="iheu-background-color" value="<?php echo $styledata[13]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <input type="text" class="form-control iheu-vendor-color" id="heading-font-color-30" name="heading-font-color" value="<?php echo $styledata[35]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                            <label for="heading-font-hover-color" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Change The Title font Color">Hover Color </label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="text" class="form-control iheu-vendor-color" id="heading-font-hover-color" name="heading-font-hover-color" value="<?php echo $styledata[83]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-2">
                                    <div class="iheu-admin-style-settings-div-css">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" id="iheu-css" name="iheu-css"><?php echo$styledata[85]; ?></textarea>
                                        </div>
                                    </div>
                                </div>
