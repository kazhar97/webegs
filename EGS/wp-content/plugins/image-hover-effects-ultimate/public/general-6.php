                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <select class="form-control" id="iheu-directions" name="iheu-directions">
                                                    <option <?php if ($styledata[85] == 'scale_up') {
    echo 'selected';
} ?> value="scale_up">Scale Up</option>
                                                    <option <?php if ($styledata[85] == 'scale_down') {
    echo 'selected';
} ?> value="scale_down">Scale Down</option>
                                                    <option <?php if ($styledata[85] == 'scale_down_up') {
    echo 'selected';
} ?> value="scale_down_up">Scale Down Up</option>
                                                </select>
                                            </div>
                                        </div>
