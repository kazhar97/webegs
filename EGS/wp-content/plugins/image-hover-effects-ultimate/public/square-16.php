...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                . 'content-height |' . sanitize_text_field($_POST['content-height']) . '|'
...
<?php iheu_item_admin_data($styledata[1]); ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="content-height" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Set Height Of yout Hover Content, After Saved Your data Will ready for Preview" >Content Height</label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="number" class="form-control" min="50" max="2400" step="1" id="content-height" name="content-height" value="<?php echo $styledata[3]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
