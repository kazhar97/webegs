...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                ...
                . 'iheu-border |' . sanitize_text_field($_POST['iheu-border']) . '|'
                . 'iheu-border-color |' . sanitize_text_field($_POST['iheu-border-color']) . '|'
                 . 'content-margin |' . sanitize_text_field($_POST['content-margin']) . '|'
                . 'box-shadow-color ||'
                            ...
                            <div class="ctu-ultimate-style-3-content">
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-6">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="content-margin" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Set Content Margin to make distance of Image to Content" >Content Margin</label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="number" class="form-control" min="0" max="100" step="1" id="content-margin" name="content-margin" value="<?php echo $styledata[29]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                    ...
                                    <div class="iheu-admin-style-settings-div-right">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="iheu-border" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Border showing on Content Body, Doesn't want make it 0" >Border</label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="number" class="form-control"  min="0" max="100" step="1" id="iheu-border" name="iheu-border" value="<?php echo $styledata[25]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                            <label for="iheu-border-color" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Border Color">Border Color </label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="text" class="form-control iheu-vendor-color" data-format="rgb" data-opacity="true"  id="iheu-border-color" name="iheu-border-color" value="<?php echo $styledata[27]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
