...
<?php iheu_font_weight_admin_panel($styledata[53]); ?>
                                    ...
                                    <div class="iheu-admin-style-settings-div-right">
                                        <div class="form-group row form-group-sm">
                                            <label for="desc-padding-bottom" class="col-sm-6 oxi-control-label" data-toggle="tooltip" data-placement="top" title="Make distance from Buttom, work as percentage of Div" >Padding Bottom</label>
                                            <div class="col-sm-6 nopadding">
