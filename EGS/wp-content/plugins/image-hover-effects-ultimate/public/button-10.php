                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <select class="form-control" id="iheu-directions" name="iheu-directions">
                                                    ...
                                                    ?> value="left_to_right">Horizontal in Out</option>
                                                    <option <?php
                                                    if ($styledata[101] == 'right_to_left') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="right_to_left">Vertical In Out</option>
                                                    <option <?php
                                                    if ($styledata[91] == 'top_to_bottom') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="top_to_bottom">Horizontal In</option>
                                                    <option <?php
                                                    if ($styledata[91] == 'bottom_to_top') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="bottom_to_top">Vertical in</option>
