                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-border-active-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li.active{border-color: " + jQuery("#heading-border-active-color").val() + "; } </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#heading-font-style").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{ font-style: " + jQuery(this).val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#heading-margin-right").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{margin: 0 " + jQuery("#heading-margin-right").val() + "px 0 0; } </style>").appendTo("#oxilab-preview-data");
                                });
                                jQuery("#heading-box-shadow-Horizontal").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?>{box-shadow: " + jQuery("#heading-box-shadow-Horizontal").val() + "px " + jQuery("#heading-box-shadow-Vertical").val() + "px " + jQuery("#heading-box-shadow-Blur").val() + "px " + jQuery("#heading-box-shadow-Spread").val() + "px " + jQuery("#heading-box-shadow-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#content-box-shadow-Horizontal").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{box-shadow: " + jQuery("#content-box-shadow-Horizontal").val() + "px " + jQuery("#content-box-shadow-Vertical").val() + "px " + jQuery("#content-box-shadow-Blur").val() + "px " + jQuery("#content-box-shadow-Spread").val() + "px " + jQuery("#content-box-shadow-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                });
