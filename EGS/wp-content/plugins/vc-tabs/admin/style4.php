                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                if (empty($styledata[71])) {
                                                    ...
                                                    echo VcTabsAdminTabsLink($styledata[71]);
                                                }
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-border-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{border-color: " + jQuery("#heading-border-color").val() + "; } </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#heading-font-style").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{font-style: " + jQuery("#heading-font-style").val() + "; } </style>").appendTo("#oxilab-preview-data");
                                });
                                jQuery('#heading-font-familly').fontselect().change(function () {
                                    ...
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-style-heading-<?php echo $styleid; ?>{ font-family:" + font[0] + ";} </style>").appendTo(".oxilab-preview-data");
                                });
                                ...
                                jQuery("#heading-width").on("change", function () {
                                    ...
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?>{min-width:  " + finalvalue + "px;} </style>").appendTo("#oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{max-width: " + jQuery("#heading-width").val() + "px; } </style>").appendTo("#oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-style-<?php echo $styleid; ?>-content{max-width: calc(100% - " + finalvalue + "px); } </style>").appendTo("#oxilab-preview-data");
                                });
                                jQuery("#heading-padding-up-bottom").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{padding: " + jQuery("#heading-padding-up-bottom").val() + "px " + jQuery("#heading-padding-left-right").val() + "px;} </style>").appendTo("#oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-style-heading-<?php echo $styleid; ?>{padding: " + jQuery("#heading-padding-up-bottom").val() + "px 10px; } </style>").appendTo("#oxilab-preview-data");
                                });
                                jQuery("#heading-padding-left-right").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{padding: " + jQuery("#heading-padding-up-bottom").val() + "px " + jQuery("#heading-padding-left-right").val() + "px; } </style>").appendTo("#oxilab-preview-data");
                                });
                                jQuery("#heading-padding-box").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?>{padding: " + jQuery("#heading-padding-box").val() + "px " + jQuery("#heading-padding-box-left").val() + "px; } </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery('#content-font-familly').fontselect().change(function () {
                                    var font = jQuery(this).val().replace(/\+/g, ' ');
                                    font = font.split(':');
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{ font-family:" + font[0] + ";} </style>").appendTo(".oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs p{ font-family:" + font[0] + ";} </style>").appendTo(".oxilab-preview-data");
                                });
                                ...
                                jQuery("#content-box-shadow-Horizontal").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?>{box-shadow: " + jQuery("#content-box-shadow-Horizontal").val() + "px " + jQuery("#content-box-shadow-Vertical").val() + "px " + jQuery("#content-box-shadow-Blur").val() + "px " + jQuery("#content-box-shadow-Spread").val() + "px " + jQuery("#content-box-shadow-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#content-box-shadow-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?>{box-shadow: " + jQuery("#content-box-shadow-Horizontal").val() + "px " + jQuery("#content-box-shadow-Vertical").val() + "px " + jQuery("#content-box-shadow-Blur").val() + "px " + jQuery("#content-box-shadow-Spread").val() + "px " + jQuery("#content-box-shadow-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-style-heading-<?php echo $styleid; ?>{box-shadow:  0 0 5px " + jQuery("#content-box-shadow-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{box-shadow:  0 0 5px " + jQuery("#content-box-shadow-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#content-width").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?>{width: calc(100% - " + jQuery("#content-width").val() + "%) ;} </style>").appendTo("#oxilab-preview-data");
                                    jQuery("<style type='text/css'>#oxilab-preview-data   .ctu-ultimate-style-<?php echo $styleid; ?>-content{width: " + jQuery("#content-width").val() + "%; } </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#content-border-left-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{border-left: 1px solid " + jQuery("#content-border-left-color").val() + ";} </style>").appendTo("#oxilab-preview-data");
                                });
                                jQuery("#span-margin-bottom").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-content-span{margin-bottom: " + jQuery("#span-margin-bottom").val() + "px;} </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#content-border-radius").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?>{border-radius: " + jQuery("#content-border-radius").val() + "px;} </style>").appendTo("#oxilab-preview-data");
                                });
